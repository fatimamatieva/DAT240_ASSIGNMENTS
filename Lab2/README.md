...
3. There should also be two that is named something like `course-assignments`, `assignments` or `labs` which is point to `https://github.com/dat240-2021/assignments` or `git@github.com:dat240-2021/assignments.git` depending on if you used https or SSH when setting up the repo.
